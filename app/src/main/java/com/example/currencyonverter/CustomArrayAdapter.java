...
public class CustomArrayAdapter extends ArrayAdapter<ListItemClass> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.data1 = convertView.findViewById(R.id.tv_data1);
            viewHolder.data2 = convertView.findViewById(R.id.tv_data2);
            viewHolder.data3 = convertView.findViewById(R.id.tv_data3);
            viewHolder.data4 = convertView.findViewById(R.id.tv_data4);
